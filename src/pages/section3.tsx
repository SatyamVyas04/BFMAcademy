...
export default function Section3() {
	return (
		<section className="relative z-0 my-4 md:-mt-48">
			...
			<h1 className="relative -z-10 px-3 text-end text-5xl font-bold uppercase tracking-wide text-brandblue md:-translate-y-4 md:text-start md:text-7xl lg:text-9xl">
				BFM Community
			</h1>
		</section>
	)
