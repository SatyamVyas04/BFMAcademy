...
export default function Section7() {
	return (
		<section className="relative min-h-96 w-full overflow-clip rounded-lg bg-foreground text-brandblue max-md:-mt-12 md:rounded-xl">
			...
			<Image
				...
				width={1200}
				alt="Avatars"
				className="absolute right-0 top-0 z-0 h-full w-fit max-md:opacity-25"
			/>
